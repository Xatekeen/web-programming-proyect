...
const SettingsManager = (() => {
  ...
  const I18N = {
    ...
    vi: { restaurants:'Nhà hàng', clubs:'Câu lạc bộ', services:'Dịch vụ', favorites:'Yêu thích',
      ...
      tagline:'Hướng dẫn dành cho sinh viên quốc tế · Gwangjin-gu, Seoul',
      searchPlaceholder:'Tìm nhà hàng, câu lạc bộ, dịch vụ...',
      filtersTitle:'Bộ lọc', budgetMax:'Ngân sách (tối đa ₩)', any:'Bất kỳ',
      cuisine:'Ẩm thực', dietary:'Chế độ ăn', openNow:'Chỉ hiện nơi đang mở',
      anyTime:'Bất kỳ giờ nào', pastMidnight:'Sau nửa đêm (00:00-05:00)',
      earlyMorning:'Sáng sớm (06:00-10:00)', lunchHours:'Giờ ăn trưa (11:00-14:00)',
      maxDistance:'Khoảng cách tối đa', sortBy:'Sắp xếp theo', sortDistance:'Khoảng cách',
      sortRating:'Đánh giá', sortPrice:'Giá (thấp đến cao)', sortClosing:'Sắp đóng cửa',
      resetFilters:'Đặt lại bộ lọc', results:'kết quả', result:'kết quả',
      emptyResults:'Không tìm thấy kết quả. Hãy thử điều chỉnh bộ lọc.',
      noFavorites:'Chưa có mục yêu thích. Nhấn ☆ trên một mục để lưu vào đây.',
      chatGreeting:'Xin chào! Hãy hỏi tôi về nhà hàng, câu lạc bộ hoặc dịch vụ gần trường — ví dụ: "nhà hàng halal gần trường".',
      chatPlaceholder:'Nhập câu hỏi...', chatSend:'Gửi', chatTitle:'Trợ lý Sejong Helper',
      timeOfDay:'Thời điểm trong ngày',
      addr:'Địa chỉ', distFromCampus:'Khoảng cách', ratingLbl:'Đánh giá', priceLbl:'Giá',
      phoneLbl:'Điện thoại', hoursLbl:'Giờ mở cửa', notesLbl:'Ghi chú', meetingLbl:'Lịch họp',
      contactLbl:'Liên hệ', languagesLbl:'Ngôn ngữ', membersLbl:'Thành viên', aboutLbl:'Giới thiệu' },
    ja: { restaurants:'レストラン', clubs:'サークル', services:'サービス', favorites:'お気に入り',
      ...
      tagline:'留学生向けガイド · ソウル広津区',
      searchPlaceholder:'レストラン・サークル・サービスを検索...',
      filtersTitle:'フィルター', budgetMax:'予算（最大 ₩）', any:'指定なし',
      cuisine:'料理の種類', dietary:'食事制限', openNow:'営業中のみ表示',
      anyTime:'時間指定なし', pastMidnight:'深夜 (00:00-05:00)',
      earlyMorning:'早朝 (06:00-10:00)', lunchHours:'ランチタイム (11:00-14:00)',
      maxDistance:'最大距離', sortBy:'並び替え', sortDistance:'距離',
      sortRating:'評価', sortPrice:'価格（安い順）', sortClosing:'閉店間近',
      resetFilters:'フィルターをリセット', results:'件', result:'件',
      emptyResults:'結果が見つかりません。フィルターを調整してください。',
      noFavorites:'お気に入りはまだありません。☆をタップして追加してください。',
      chatGreeting:'こんにちは！キャンパス周辺のレストラン・サークル・サービスについて質問してください — 例：「ハラルレストランは？」',
      chatPlaceholder:'質問を入力...', chatSend:'送信', chatTitle:'세종 Helper アシスタント',
      timeOfDay:'時間帯',
      addr:'住所', distFromCampus:'距離', ratingLbl:'評価', priceLbl:'価格',
      phoneLbl:'電話番号', hoursLbl:'営業時間', notesLbl:'メモ', meetingLbl:'集まりの時間',
      contactLbl:'連絡先', languagesLbl:'言語', membersLbl:'メンバー数', aboutLbl:'概要' },
    ru: { restaurants:'Рестораны', clubs:'Клубы', services:'Услуги', favorites:'Избранное',
      ...
      tagline:'Гид для иностранных студентов · Кванджин-гу, Сеул',
      searchPlaceholder:'Поиск ресторанов, клубов, услуг...',
      filtersTitle:'Фильтры', budgetMax:'Бюджет (макс. ₩)', any:'Любой',
      cuisine:'Кухня', dietary:'Диета', openNow:'Только открытые сейчас',
      anyTime:'Любое время', pastMidnight:'После полуночи (00:00-05:00)',
      earlyMorning:'Раннее утро (06:00-10:00)', lunchHours:'Обеденное время (11:00-14:00)',
      maxDistance:'Макс. расстояние', sortBy:'Сортировать по', sortDistance:'Расстояние',
      sortRating:'Рейтинг', sortPrice:'Цена (по возрастанию)', sortClosing:'Скоро закроется',
      resetFilters:'Сбросить фильтры', results:'результатов', result:'результат',
      emptyResults:'Ничего не найдено. Попробуйте изменить фильтры.',
      noFavorites:'Пока нет избранного. Нажмите ☆, чтобы добавить.',
      chatGreeting:'Привет! Спросите меня о ресторанах, клубах или услугах рядом с кампусом — например, "халяльные рестораны рядом".',
      chatPlaceholder:'Введите вопрос...', chatSend:'Отправить', chatTitle:'Помощник Sejong Helper',
      timeOfDay:'Время суток',
      addr:'Адрес', distFromCampus:'Расстояние', ratingLbl:'Рейтинг', priceLbl:'Цена',
      phoneLbl:'Телефон', hoursLbl:'Часы работы', notesLbl:'Примечания', meetingLbl:'Встречи',
      contactLbl:'Контакт', languagesLbl:'Языки', membersLbl:'Участники', aboutLbl:'О клубе' },
    mn: { restaurants:'Рестораны', clubs:'Клубууд', services:'Үйлчилгээ', favorites:'Дуртай',
      ...
      tagline:'Гадаад оюутны гарын авлага · Гванжин-гу, Сөүл',
      searchPlaceholder:'Ресторан, клуб, үйлчилгээ хайх...',
      filtersTitle:'Шүүлтүүр', budgetMax:'Төсөв (дээд ₩)', any:'Бүгд',
      cuisine:'Хоолны төрөл', dietary:'Хоолны хязгаарлалт', openNow:'Одоо нээлттэйг харуулах',
      anyTime:'Хэдийд ч', pastMidnight:'Шөнө дунд хэтэрсэн (00:00-05:00)',
      earlyMorning:'Өглөө эрт (06:00-10:00)', lunchHours:'Үдийн цай (11:00-14:00)',
      maxDistance:'Дээд зай', sortBy:'Эрэмбэлэх', sortDistance:'Зай',
      sortRating:'Үнэлгээ', sortPrice:'Үнэ (багаас их)', sortClosing:'Удахгүй хаагдах',
      resetFilters:'Шүүлтүүр арилгах', results:'үр дүн', result:'үр дүн',
      emptyResults:'Үр дүн олдсонгүй. Шүүлтүүрээ өөрчилж үзнэ үү.',
      noFavorites:'Дуртай зүйл алга байна. ☆ дээр дарж нэмнэ үү.',
      chatGreeting:'Сайн уу! Кампус орчмын ресторан, клуб, үйлчилгээний талаар асуугаарай — жишээ нь "халал ресторан хаана байна?"',
      chatPlaceholder:'Асуултаа бичих...', chatSend:'Илгээх', chatTitle:'Sejong Helper туслах',
      timeOfDay:'Өдрийн цаг',
      addr:'Хаяг', distFromCampus:'Зай', ratingLbl:'Үнэлгээ', priceLbl:'Үнэ',
      phoneLbl:'Утас', hoursLbl:'Цагийн хуваарь', notesLbl:'Тэмдэглэл', meetingLbl:'Цуглаан',
      contactLbl:'Холбоо барих', languagesLbl:'Хэл', membersLbl:'Гишүүд', aboutLbl:'Тухай' },
    uz: { restaurants:'Restoranlar', clubs:'Klublar', services:'Xizmatlar', favorites:'Sevimlilar',
      ...
      tagline:'Xalqaro talabalar uchun qoʻllanma · Gwangjin-gu, Seul',
      searchPlaceholder:'Restoran, klub, xizmatlarni qidirish...',
      filtersTitle:'Filtrlar', budgetMax:'Byudjet (maks. ₩)', any:'Istalgan',
      cuisine:'Oshxona turi', dietary:'Parhez', openNow:'Faqat hozir ochiq',
      anyTime:'Istalgan vaqt', pastMidnight:'Yarim tundan keyin (00:00-05:00)',
      earlyMorning:'Erta tong (06:00-10:00)', lunchHours:'Tushlik vaqti (11:00-14:00)',
      maxDistance:'Maksimal masofa', sortBy:'Saralash', sortDistance:'Masofa',
      sortRating:'Reyting', sortPrice:'Narx (arzondan qimmatga)', sortClosing:'Yaqinda yopiladi',
      resetFilters:'Filtrlarni tozalash', results:'natija', result:'natija',
      emptyResults:'Hech narsa topilmadi. Filtrlarni o‘zgartirib ko‘ring.',
      noFavorites:'Hali sevimlilar yo‘q. Qoʻshish uchun ☆ belgisini bosing.',
      chatGreeting:'Salom! Kampus atrofidagi restoran, klub yoki xizmatlar haqida so‘rang — masalan, "yaqin atrofdagi halol restoranlar".',
      chatPlaceholder:'Savolingizni yozing...', chatSend:'Yuborish', chatTitle:'Sejong Helper yordamchisi',
      timeOfDay:'Kun vaqti',
      addr:'Manzil', distFromCampus:'Masofa', ratingLbl:'Reyting', priceLbl:'Narx',
      phoneLbl:'Telefon', hoursLbl:'Ish vaqti', notesLbl:'Eslatmalar', meetingLbl:'Uchrashuv',
      contactLbl:'Aloqa', languagesLbl:'Tillar', membersLbl:'Aʻzolar', aboutLbl:'Haqida' },
    ar: { restaurants:'مطاعم', clubs:'أندية', services:'خدمات', favorites:'المفضلة',
      ...
      tagline:'دليل الطلاب الدوليين · غوانغجين-غو، سيول',
      searchPlaceholder:'البحث عن مطاعم، أندية، خدمات...',
      filtersTitle:'الفلاتر', budgetMax:'الميزانية (الحد الأقصى ₩)', any:'الكل',
      cuisine:'نوع المطبخ', dietary:'النظام الغذائي', openNow:'إظهار المفتوح حالياً فقط',
      anyTime:'أي وقت', pastMidnight:'بعد منتصف الليل (00:00-05:00)',
      earlyMorning:'الصباح الباكر (06:00-10:00)', lunchHours:'وقت الغداء (11:00-14:00)',
      maxDistance:'أقصى مسافة', sortBy:'ترتيب حسب', sortDistance:'المسافة',
      sortRating:'التقييم', sortPrice:'السعر (من الأقل للأعلى)', sortClosing:'سيغلق قريباً',
      resetFilters:'إعادة ضبط الفلاتر', results:'نتائج', result:'نتيجة',
      emptyResults:'لم يتم العثور على نتائج. حاول تعديل الفلاتر.',
      noFavorites:'لا توجد عناصر مفضلة بعد. اضغط على ☆ لإضافة عنصر هنا.',
      chatGreeting:'مرحباً! اسألني عن المطاعم أو الأندية أو الخدمات القريبة من الحرم الجامعي — مثل "مطاعم حلال قريبة".',
      chatPlaceholder:'اكتب سؤالاً...', chatSend:'إرسال', chatTitle:'مساعد Sejong Helper',
      timeOfDay:'وقت اليوم',
      addr:'العنوان', distFromCampus:'المسافة', ratingLbl:'التقييم', priceLbl:'السعر',
      phoneLbl:'الهاتف', hoursLbl:'ساعات العمل', notesLbl:'ملاحظات', meetingLbl:'وقت الاجتماع',
      contactLbl:'التواصل', languagesLbl:'اللغات', membersLbl:'الأعضاء', aboutLbl:'حول' }
  };
  function t(key) {
